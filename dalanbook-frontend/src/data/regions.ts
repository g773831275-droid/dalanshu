...
export const AGE_RANGE_OPTIONS = [
  ["unknown", "不愿透露"], ["under18", "18 岁以下"], ["18-24", "18–24 岁"],
  ["25-29", "25–29 岁"], ["30-34", "30–34 岁"], ["35-39", "35–39 岁"],
  ["40-49", "40–49 岁"], ["50plus", "50 岁以上"],
] as const;

export function ageRangeLabel(value?: string) {
  return AGE_RANGE_OPTIONS.find(([key]) => key === value)?.[1] ?? "不愿透露";
}
