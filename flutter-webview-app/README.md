...
The project package name is `dalanbook_webview_app`. Run it from this directory:
...
On Android, HTML file inputs for images and videos are bridged to the native
media picker and support multiple image selection. iOS uses WKWebView's native
file input handling. Photo library, camera, and microphone usage descriptions
are configured for both upload flows.
